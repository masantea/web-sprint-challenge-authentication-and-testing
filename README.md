...
- JWTs are easy to scale horizontally
- JWTs are easier to maintain and debug
- JWTs have the ability to create truly RESTful Services

2. What does `bcrypt` do to help us store passwords in a secure manner.
- The bcrypt hashing function allows us to build a password security platform that scales with computation power and always hashes every password with a salt

3. How are unit tests different from integration and end-to-end testing.
- Integration est how different parts of the system work together. This is different from the unit tests we use to verify the correctness of one part of the system in isolation

4. How _Test Driven Development_ changes the way we write applications and tests.
- Test driven development allows us to write tests before code. This allows for a much higher quality code. 
